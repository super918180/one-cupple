...
!function(a, b) {
    function c(a) {
        var c = parseFloat(a.designWidth)
          ...
          , l = a.className || "grid";
        if (!(a.designWidth && a.designUnit && a.columnCount && a.columnXUnit && a.gutterXUnit && a.edgeXUnit))
            throw new Error("参数错误");
        b.flexible.gridParams = a;
        for (var m = d / c * 10, n = i * m, o = j * m, p = k * m, q = ["." + l + " {", "box-sizing:content-box;", "padding-left: " + p + "rem;", "padding-right: " + p + "rem;", "margin-left: -" + o + "rem;", "}", "." + l + ":before,", "." + l + ":after{", 'content: " ";', "display: table;", "}", "." + l + ":after {", "clear: both;", "}", "." + l + ' [class^="col-"] {', "margin-left: " + o + "rem;", "float: left;", "}"], r = 1; h >= r; r++) {
            var s = n * r + o * (r - 1);
            q.push("." + l + " .col-" + r + " {width: " + s + "rem;}")
        }
        e && e.parentNode && e.parentNode.removeChild(e),
        e = f.createElement("style"),
        e.innerHTML = q.join("");
        var t = f.querySelector("head") || g.firstElementChild || g;
        t.appendChild(e)
    }
    function d(a) {
        var b = j[a];
    ...
    var e, f = a.document, g = f.documentElement, h = f.querySelector('meta[name="grid"]'), i = b.flexible || (b.flexible = {}), j = {
        "750-12": {
            designWidth: 750,
            designUnit: 6,
            columnCount: 12,
